...
command time -v --output=./logs/time_output_${1}_${2}.txt ./target/release/examples/validate_btc_header_batch scripts/headers_100000.txt $1 $2 > ./logs/output_${1}_${2}.txt
